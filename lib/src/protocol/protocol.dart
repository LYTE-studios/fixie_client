...
import 'locales/user_locales.dart' as _i11;
...
import 'statistics/statistics.dart' as _i15;
...
import 'package:fixie_client/src/protocol/category/category.dart' as _i21;
import 'package:fixie_client/src/protocol/journals/journal_log.dart' as _i22;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i11.UserLocales) {
      return _i11.UserLocales.fromJson(data) as T;
    }
    ...
    if (t == _i15.Statistics) {
      return _i15.Statistics.fromJson(data) as T;
    }
    ...
    if (t == _i1.getType<_i11.UserLocales?>()) {
      return (data != null ? _i11.UserLocales.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<_i15.Statistics?>()) {
      return (data != null ? _i15.Statistics.fromJson(data) : null) as T;
    }
    ...
    if (t == _i1.getType<List<_i19.RegistrationLog>?>()) {
      return (data != null
          ? (data as List)
              .map((e) => deserialize<_i19.RegistrationLog>(e))
              .toList()
          : null) as dynamic;
    }
    if (t == List<String>) {
    ...
    if (t == List<_i20.Goal>) {
      return (data as List).map((e) => deserialize<_i20.Goal>(e)).toList()
          as dynamic;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'UserLocales') {
      return deserialize<_i11.UserLocales>(data['data']);
    }
    ...
    if (data['className'] == 'Statistics') {
      return deserialize<_i15.Statistics>(data['data']);
    }
