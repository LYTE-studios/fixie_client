...
import 'repeatable_days.dart' as _i8;
...
import 'package:fixie_client/src/protocol/goal.dart' as _i15;
import 'package:fixie_client/src/protocol/journal_log.dart' as _i16;
...
class Protocol extends _i1.SerializationManager {
  ...
  T deserialize<T>(
    ...
    if (t == _i8.RepeatableDays) {
      return _i8.RepeatableDays.fromJson(data) as T;
    }
    if (t == _i9.Repetition) {
    ...
    if (t == _i1.getType<_i8.RepeatableDays?>()) {
      return (data != null ? _i8.RepeatableDays.fromJson(data) : null) as T;
    }
  ...
  dynamic deserializeByClassName(Map<String, dynamic> data) {
    ...
    if (data['className'] == 'RepeatableDays') {
      return deserialize<_i8.RepeatableDays>(data['data']);
    }
